...
class DepthDecoder(nn.Module):
    def __init__(self, num_ch_enc, scales=range(4), num_output_channels=1, use_skips=True):
        ...
        self.num_ch_dec = np.array([64, 256, 512, 1024])
        ...
        self.cov4 = ConvBlock(2048, 1024)
        self.cov3 = ConvBlock(1024, 512)
        self.cov2 = ConvBlock(512, 256)
        self.cov1 = ConvBlock(256, 64)
        self.TFAM4 = TFAM(1024)
        self.TFAM3 = SFF(512)
        self.TFAM2 = SFF(256)
        self.TFAM1 = SFF(64)
